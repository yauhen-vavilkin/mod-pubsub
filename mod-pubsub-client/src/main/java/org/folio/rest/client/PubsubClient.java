...
public class PubsubClient {
   ...
   *
   */
  public void deletePubsubMessagingModules(String moduleId, String moduleRole, Handler<HttpClientResponse> responseHandler)
    throws UnsupportedEncodingException
  {
    // Auto-generated code
    // - generated by       org.folio.rest.tools.ClientGenerator
    ...
    io.vertx.core.http.HttpClientRequest request = httpClient.deleteAbs(okapiUrl+"/pubsub/messaging-modules"+queryParams.toString());
    request.handler(responseHandler);
    request.putHeader("Accept", "text/plain");
    if (tenantId!= null) {
      request.putHeader("X-Okapi-Token", token);
